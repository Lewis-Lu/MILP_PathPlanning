function ofile = integer_planner_2D_time_selection_first(pos_init, vel_init, pos_final, vel_final,...
...
%
% ofile = integer_planner_2D_time_selection(pos_init, vel_init, pos_final, vel_final,...
...
% Last Modified: 22 Aug 2021
    ...
    model = [model_root     'integer_planner_2D_time_selection_first.mod '];
    data = [data_root       'integer_planner_2D_time_selection_first.dat '];
    ofile = [output_root    'integer_planner_2D_time_selection_first.txt '];
