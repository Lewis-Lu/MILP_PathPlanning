function ofile = integer_planner_2D(pos_init, vel_init, pos_final, vel_final,...
...
%     ctn = ctn + AMPLvector(fid, 'vel_final', vel_final);
    ...
    model = [model_root 'integer_planner_2D.mod '];
    data = [data_root 'integer_planner_2D.dat '];
    ofile = [output_root 'integer_planner_2D.txt '];
