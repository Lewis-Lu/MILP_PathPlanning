function ofile = integer_planner_2D_time_selection_iterative(pos_init, vel_init, pos_final, vel_final,...
    obs_info, opbox, num_vel_cst, num_acc_cst, num_obs_cst,...
    acc_max, vel_max, vel_min, num_ts, timeStamp, out_data_file)    
% This function is integer planner in 2D environment, and the function
% returns the results from the solver.
%
% ofile = integer_planner_2D_time_selection_iterative(pos_init, vel_init, pos_final, vel_final,...
%     wind_disturb, obs_info, opbox, num_vel_cst, num_acc_cst, num_obs_cst,...
...
% Last Modified: 22 Aug 2021
    ...
    ctn = ctn + AMPLscalarint(fid, 'obs_inflation', 1);
    ...
    model = [model_root     'integer_planner_2D_time_selection_iterative.mod '];
    data = [data_root       'integer_planner_2D_time_selection_iterative.dat '];
    ofile = [output_root    'integer_planner_2D_time_selection_iterative.txt '];
